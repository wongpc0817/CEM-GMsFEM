...
if not os.path.isdir('Plots/cd_ex6'):
    os.makedirs('Plots/cd_ex6')
...
for sec_ind in range(SEC_NUM):
        for sub_sec_ind in range(SUB_SEC_NUM):
            data = np.load(f"Results/cd_ex6/op_{op}_{sec_ind}_{sub_sec_ind}.npz")
            ...
            fig.savefig(f'Plots/cd_ex6/op_{op}_{sec_ind}_{sub_sec_ind}_u0_ms.png')
            fig=plt.figure()
            ax=fig.add_subplot(111,projection='3d')
            ax.plot_surface(x,y,u0_ref)
            fig.savefig(f'Plots/cd_ex6/op_{op}_{sec_ind}_{sub_sec_ind}_u0_ref.png')
...
for sec_ind in range(SEC_NUM):
        for sub_sec_ind in range(SUB_SEC_NUM):
            data = np.load(f"Results/cd_ex6/op_{op}_{sub_sec_ind}.npz")
            ...
            ax=fig.add_subplot(111,projection='3d')
            ax.plot_surface(x,y,u0_ms)
            fig.savefig(f'Plots/cd_ex6/op_{op}_{sub_sec_ind}_u0_ms.png')
            fig=plt.figure()
            ax=fig.add_subplot(111,projection='3d')
            ax.plot_surface(x,y,u0_ref)
            fig.savefig(f'Plots/cd_ex6/op_{op}_{sub_sec_ind}_u0_ref.png')
...
for sec_ind in range(SEC_NUM):
        for sub_sec_ind in range(SUB_SEC_NUM):
            data = np.load(f"Results/cd_ex6/op_{op}_{sec_ind}.npz")
            ...
            ax=fig.add_subplot(111,projection='3d')
            ax.plot_surface(x,y,u0_ms)
            fig.savefig(f'Plots/cd_ex6/op_{op}_{sec_ind}_u0_ms.png')
            fig=plt.figure()
            ax=fig.add_subplot(111,projection='3d')
            ax.plot_surface(x,y,u0_ref)
            fig.savefig(f'Plots/cd_ex6/op_{op}_{sec_ind}_u0_ref.png')